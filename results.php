...
mysqli_select_db('PE');
$query = "select * from fixtures where ".$searchtype." like '%".$searchterm."%' ORDER by date";
...
?>
</span><span class="h2">You have searched for: </span><span class="body">
<?php echo $_POST["fsearchtype"]; ?>
</span><span class="h2">with the criteria:
</span><span class="body">
<?php echo $_POST["fsearchcriteria"];
echo '<br><br><a href="fixturesrcstaff.php">Fixture search page</a></br></br>';
echo '<a href="logout.php">Log out</a><br />';?>
</span></p>
