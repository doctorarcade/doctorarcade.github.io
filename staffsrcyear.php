...
<p><span class="h1">Fixture Search Results ‐ By Year Group</span></p>
<p><span class="body">
<?php
...
mysqli_select_db('PE');
$query = "select * from fixtures where ".$searchyear." like 'Yes' ORDER BY date";
...
?>
</span><span class="h2">You have searched for the year group:
</span><span class="body">
<?php echo $_POST["fsearchyearonly"];
